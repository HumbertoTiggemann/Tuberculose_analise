...
Este é um projeto de análise de dados com Python, realizado em grupo para o modulo Técnicas de Programação I. 
O projeto é apresentado no Jupyter, mas nas fases de obtenção e tratamento dos dados brutos fez-se necessário também o uso do R.
